...
import {
  ...
  Mic, Crown, Send, RotateCcw, Loader2, Timer, Lightbulb, Database,
} from "lucide-react";
const CodeRunner = lazy(() => import("../components/CodeRunner"));
const SqlRunner = lazy(() => import("../components/SqlRunner"));
const RunnerFallback = () => (
  <div className="rounded-xl border border-line bg-card p-8 text-center text-ink2 text-sm">Loading editor…</div>
);
function Lazy({ children }) { return <Suspense fallback={<RunnerFallback />}>{children}</Suspense>; }
...
const dsaTopics = [
  { name: "Arrays & Hashing", patterns: "Frequency maps, prefix sums, in-place swaps", problems: [["Contains Duplicate", "Easy"], ["Two Sum", "Easy"], ["Valid Anagram", "Easy"], ["Concatenation of Array", "Easy"], ["Replace Elements with Greatest Element on Right Side", "Easy"], ["Is Subsequence", "Easy"], ["Longest Common Prefix", "Easy"], ["Majority Element", "Easy"], ["Group Anagrams", "Medium"], ["Top K Frequent Elements", "Medium"], ["Product of Array Except Self", "Medium"], ["Valid Sudoku", "Medium"], ["Encode and Decode Strings", "Medium"], ["Longest Consecutive Sequence", "Medium"], ["Sort Colors", "Medium"], ["Subarray Sum Equals K", "Medium"], ["First Missing Positive", "Hard"]] },
  { name: "Two Pointers", patterns: "Opposite ends, fast/slow, sorted scans", problems: [["Valid Palindrome", "Easy"], ["Valid Palindrome II", "Easy"], ["Move Zeroes", "Easy"], ["Remove Duplicates from Sorted Array", "Easy"], ["Two Sum II", "Medium"], ["3Sum", "Medium"], ["4Sum", "Medium"], ["Container With Most Water", "Medium"], ["Boats to Save People", "Medium"], ["Trapping Rain Water", "Hard"]] },
  { name: "Sliding Window", patterns: "Expand/contract a window, track the best", problems: [["Best Time to Buy and Sell Stock", "Easy"], ["Maximum Average Subarray I", "Easy"], ["Longest Substring Without Repeating Characters", "Medium"], ["Longest Repeating Character Replacement", "Medium"], ["Permutation in String", "Medium"], ["Fruit Into Baskets", "Medium"], ["Minimum Size Subarray Sum", "Medium"], ["Minimum Window Substring", "Hard"], ["Sliding Window Maximum", "Hard"]] },
  { name: "Stack", patterns: "Monotonic stack, matching pairs", problems: [["Valid Parentheses", "Easy"], ["Implement Queue using Stacks", "Easy"], ["Min Stack", "Medium"], ["Evaluate Reverse Polish Notation", "Medium"], ["Generate Parentheses", "Medium"], ["Daily Temperatures", "Medium"], ["Car Fleet", "Medium"], ["Asteroid Collision", "Medium"], ["Decode String", "Medium"], ["Largest Rectangle in Histogram", "Hard"]] },
  { name: "Binary Search", patterns: "Halve the search space, search on the answer", problems: [["Binary Search", "Easy"], ["Guess Number Higher or Lower", "Easy"], ["Sqrt(x)", "Easy"], ["Search a 2D Matrix", "Medium"], ["Koko Eating Bananas", "Medium"], ["Find Minimum in Rotated Sorted Array", "Medium"], ["Search in Rotated Sorted Array", "Medium"], ["Find Peak Element", "Medium"], ["Time Based Key-Value Store", "Medium"], ["Median of Two Sorted Arrays", "Hard"]] },
  { name: "Linked List", patterns: "Dummy nodes, two pointers, cycle detection", problems: [["Reverse Linked List", "Easy"], ["Merge Two Sorted Lists", "Easy"], ["Linked List Cycle", "Easy"], ["Palindrome Linked List", "Easy"], ["Remove Nth Node From End of List", "Medium"], ["Reorder List", "Medium"], ["Copy List with Random Pointer", "Medium"], ["Add Two Numbers", "Medium"], ["Find the Duplicate Number", "Medium"], ["LRU Cache", "Medium"], ["Merge K Sorted Lists", "Hard"], ["Reverse Nodes in k-Group", "Hard"]] },
  { name: "Trees", patterns: "DFS/BFS, recursion, BST invariants", problems: [["Invert Binary Tree", "Easy"], ["Maximum Depth of Binary Tree", "Easy"], ["Diameter of Binary Tree", "Easy"], ["Balanced Binary Tree", "Easy"], ["Same Tree", "Easy"], ["Subtree of Another Tree", "Easy"], ["Lowest Common Ancestor of a BST", "Medium"], ["Binary Tree Level Order Traversal", "Medium"], ["Binary Tree Right Side View", "Medium"], ["Count Good Nodes in Binary Tree", "Medium"], ["Validate Binary Search Tree", "Medium"], ["Kth Smallest Element in a BST", "Medium"], ["Construct Binary Tree from Preorder and Inorder Traversal", "Medium"], ["Binary Tree Maximum Path Sum", "Hard"], ["Serialize and Deserialize Binary Tree", "Hard"]] },
  { name: "Tries", patterns: "Prefix trees, fast word lookups", problems: [["Implement Trie (Prefix Tree)", "Medium"], ["Design Add and Search Words Data Structure", "Medium"], ["Word Search II", "Hard"]] },
  { name: "Heap / Priority Queue", patterns: "Top-K, streaming medians, scheduling", problems: [["Kth Largest Element in a Stream", "Easy"], ["Last Stone Weight", "Easy"], ["K Closest Points to Origin", "Medium"], ["Kth Largest Element in an Array", "Medium"], ["Task Scheduler", "Medium"], ["Design Twitter", "Medium"], ["Find Median from Data Stream", "Hard"]] },
  { name: "Backtracking", patterns: "Choose → explore → un-choose", problems: [["Subsets", "Medium"], ["Subsets II", "Medium"], ["Combination Sum", "Medium"], ["Combination Sum II", "Medium"], ["Permutations", "Medium"], ["Word Search", "Medium"], ["Palindrome Partitioning", "Medium"], ["Letter Combinations of a Phone Number", "Medium"], ["N-Queens", "Hard"]] },
  { name: "Graphs", patterns: "BFS/DFS, union-find, topological sort", problems: [["Number of Islands", "Medium"], ["Max Area of Island", "Medium"], ["Clone Graph", "Medium"], ["Walls and Gates", "Medium"], ["Rotting Oranges", "Medium"], ["Pacific Atlantic Water Flow", "Medium"], ["Surrounded Regions", "Medium"], ["Course Schedule", "Medium"], ["Course Schedule II", "Medium"], ["Graph Valid Tree", "Medium"], ["Number of Connected Components in an Undirected Graph", "Medium"], ["Redundant Connection", "Medium"], ["Word Ladder", "Hard"]] },
  { name: "Advanced Graphs", patterns: "Dijkstra, MST, topological order", problems: [["Network Delay Time", "Medium"], ["Cheapest Flights Within K Stops", "Medium"], ["Min Cost to Connect All Points", "Medium"], ["Reconstruct Itinerary", "Hard"], ["Swim in Rising Water", "Hard"], ["Alien Dictionary", "Hard"]] },
  { name: "1-D Dynamic Programming", patterns: "Memoize, design the state, build a table", problems: [["Climbing Stairs", "Easy"], ["Min Cost Climbing Stairs", "Easy"], ["House Robber", "Medium"], ["House Robber II", "Medium"], ["Longest Palindromic Substring", "Medium"], ["Palindromic Substrings", "Medium"], ["Decode Ways", "Medium"], ["Coin Change", "Medium"], ["Maximum Product Subarray", "Medium"], ["Word Break", "Medium"], ["Longest Increasing Subsequence", "Medium"], ["Partition Equal Subset Sum", "Medium"]] },
  { name: "2-D Dynamic Programming", patterns: "Grids, two sequences, knapsack", problems: [["Unique Paths", "Medium"], ["Longest Common Subsequence", "Medium"], ["Best Time to Buy and Sell Stock with Cooldown", "Medium"], ["Coin Change II", "Medium"], ["Target Sum", "Medium"], ["Interleaving String", "Medium"], ["Edit Distance", "Hard"], ["Distinct Subsequences", "Hard"], ["Burst Balloons", "Hard"], ["Regular Expression Matching", "Hard"]] },
  { name: "Greedy", patterns: "Local optimal choices → global optimum", problems: [["Maximum Subarray", "Medium"], ["Jump Game", "Medium"], ["Jump Game II", "Medium"], ["Gas Station", "Medium"], ["Hand of Straights", "Medium"], ["Merge Triplets to Form Target Triplet", "Medium"], ["Partition Labels", "Medium"], ["Valid Parenthesis String", "Medium"]] },
  { name: "Intervals", patterns: "Sort by start/end, merge & sweep", problems: [["Meeting Rooms", "Easy"], ["Insert Interval", "Medium"], ["Merge Intervals", "Medium"], ["Non-overlapping Intervals", "Medium"], ["Meeting Rooms II", "Medium"], ["Minimum Interval to Include Each Query", "Hard"]] },
  { name: "Bit Manipulation", patterns: "XOR tricks, masks, shifts", problems: [["Single Number", "Easy"], ["Number of 1 Bits", "Easy"], ["Counting Bits", "Easy"], ["Reverse Bits", "Easy"], ["Missing Number", "Easy"], ["Sum of Two Integers", "Medium"], ["Reverse Integer", "Medium"]] },
  { name: "Math & Geometry", patterns: "Matrix moves, number theory", problems: [["Happy Number", "Easy"], ["Plus One", "Easy"], ["Rotate Image", "Medium"], ["Spiral Matrix", "Medium"], ["Set Matrix Zeroes", "Medium"], ["Pow(x, n)", "Medium"], ["Multiply Strings", "Medium"], ["Detect Squares", "Medium"]] },
];
...
const ASSESSMENTS = [
  { id: "dsa-sprint", name: "DSA Sprint", type: "dsa", count: 2, mins: 30, desc: "Two random coding problems against the clock." },
  { id: "dsa-marathon", name: "DSA Marathon", type: "dsa", count: 3, mins: 45, desc: "Three problems, a longer window — endurance round." },
  { id: "dsa-warmup", name: "DSA Warm-up", type: "dsa", count: 2, mins: 20, diff: "Easy", desc: "Two easier problems to warm up." },
  { id: "sd-round", name: "System Design Round", type: "system", count: 2, mins: 40, desc: "Two open-ended system-design prompts." },
  { id: "sd-deep", name: "System Design Deep Dive", type: "system", count: 3, mins: 60, desc: "Three prompts — go deep on architecture & trade-offs." },
  { id: "mixed", name: "Mixed Interview", type: "mixed", count: 3, mins: 50, desc: "A blend of DSA and system-design questions." },
];
...
export default function Prep() {
  ...
  const measureTab = () => { const el = tabRefs.current[view]; if (el) setInd({ left: el.offsetLeft, width: el.offsetWidth }); };
  useLayoutEffect(() => { measureTab(); const t = setTimeout(measureTab, 180); return () => clearTimeout(t); }, [view]);
  useEffect(() => { window.addEventListener("resize", measureTab); return () => window.removeEventListener("resize", measureTab); });
  ...
  const [pHint, setPHint] = useState(""); const [pHintLoading, setPHintLoading] = useState(false);
  const [pSol, setPSol] = useState(""); const [pSolLoading, setPSolLoading] = useState(false);
  const [pHelpErr, setPHelpErr] = useState(""); const [solUpgrade, setSolUpgrade] = useState(false);
  ...
  const pickRandomN = (arr, n) => [...arr].sort(() => Math.random() - 0.5).slice(0, n);
  const buildItems = (a) => {
    const dsaNames = Object.keys(dsaProblems).filter((n) => !a.diff || dsaProblems[n].difficulty === a.diff);
    if (a.type === "dsa") return pickRandomN(dsaNames, a.count).map((name) => ({ type: "dsa", name }));
    if (a.type === "system") return pickRandomN(sysDesign, a.count).map((q) => ({ type: "system", q }));
    const nd = Math.ceil(a.count / 2);
    return [
      ...pickRandomN(dsaNames, nd).map((name) => ({ type: "dsa", name })),
      ...pickRandomN(sysDesign, a.count - nd).map((q) => ({ type: "system", q })),
    ];
  };
  const asStart = (a) => {
    setAsChosen(a); setAsItems(buildItems(a)); setAsActive(0); setAsSolved({}); setAsNotes({}); setAsLeft(a.mins * 60); setAsDone(false);
  };
  const asFinish = () => setAsDone(true);
  const asReset = () => { setAsChosen(null); setAsDone(false); setAsItems([]); setAsSolved({}); setAsNotes({}); setAsLeft(0); setAsActive(0); };
  const ivErr = (e) => {
    if (e?.response?.status === 403) { setIvUpgrade(true); return; }
  ...
  useEffect(() => {
    ...
    if (asLeft <= 0) { setAsDone(true); return; }
    const t = setTimeout(() => setAsLeft((x) => x - 1), 1000);
    return () => clearTimeout(t);
  }, [asChosen, asDone, asLeft]);
  useEffect(() => { setPHint(""); setPSol(""); setPHelpErr(""); }, [activeProblem]);
  useEffect(() => { setSysChecks({}); setSysNotes(""); }, [activeSys]);
  useEffect(() => { setCodeSysChecks({}); setCodeSysNotes(""); }, [codeSysIdx]);
  const getHint = async () => {
    if (!activeProblem) return;
    setPHelpErr(""); setPHintLoading(true);
    try { const pr = dsaProblems[activeProblem]; const { data } = await api.post("/ai/hint", { title: activeProblem, statement: pr.statement }); setPHint(data.text || ""); }
    catch (e) { setPHelpErr(e?.response?.data?.error || e?.response?.data?.msg || "Could not get a hint."); }
    setPHintLoading(false);
  };
  const getSolution = async () => {
    if (!activeProblem) return;
    if (!isPro) { setSolUpgrade(true); return; }
    setPHelpErr(""); setPSolLoading(true);
    try { const pr = dsaProblems[activeProblem]; const { data } = await api.post("/ai/solution", { title: activeProblem, statement: pr.statement, difficulty: pr.difficulty }); setPSol(data.text || ""); }
    catch (e) { if (e?.response?.status === 403) setSolUpgrade(true); else setPHelpErr(e?.response?.data?.error || e?.response?.data?.msg || "Could not load the solution."); }
  ...
  useEffect(() => {
    api.get("/progress").then(({ data }) => {
      setSolved((s) => {
        const merged = { ...s };
        (data.solved || []).forEach((name) => { merged[name] = true; });
        try { localStorage.setItem("craftcv_solved", JSON.stringify(merged)); } catch {}
        return merged;
      });
    }).catch(() => {});
  }, []);
  const toggleSolved = (name) => setSolved((s) => {
    ...
    api.post("/progress/solve", { problem: name, solved: willSolve }).catch(() => {});
    return n;
  });
  const recordSubmission = (problem, verdict) => {
    if (!problem) return;
    api.post("/progress/submit", { problem, verdict, language: "python" }).catch(() => {});
    if (verdict === "Accepted") setSolved((s) => {
  ...
  return (
    <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12 py-8 sm:py-10">
      <div className="w-full lg:grid lg:grid-cols-[236px_minmax(0,1fr)] lg:gap-8 lg:items-start">
        <div className="mb-6 lg:col-span-2">
          <h1 className="font-display text-3xl sm:text-4xl font-semibold">Interview Studio</h1>
          <p className="text-ink2 mt-1.5 max-w-2xl">Master DSA patterns across every level, rehearse behavioral answers, learn system design, practice SQL, and jump into a professional compiler — everything in one place.</p>
        </div>

        {/* menu — grouped sidebar */}
        <aside className="lg:sticky lg:top-20 lg:self-start mb-6 lg:mb-0">
          <nav className="flex lg:flex-col gap-1 lg:gap-0.5 overflow-x-auto lg:overflow-visible -mx-4 px-4 lg:mx-0 lg:px-3 lg:py-3 lg:bg-card/40 lg:border lg:border-line lg:rounded-2xl lg:backdrop-blur-sm [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
            {[
              ["Practice", [["dsa", "DSA Topics", Brain], ["code", "Code Practice", Code2], ["sql", "SQL", Database], ["assessment", "Assessments", Timer]]],
              ["Learn", [["theory", "DSA Course", GraduationCap], ["system", "System Design", Network], ["behavioral", "Behavioral", MessageSquare]]],
              ["Interview", [["interview", "Mock Interview", Mic]]],
              ["Explore", [["companies", "Companies", Building2]]],
            ].map(([title, items], gi) => (
              <div key={title} className="contents lg:block">
                <div className="hidden lg:flex items-center gap-2 text-[10px] font-bold uppercase tracking-[.12em] text-ink2/60 mt-4 first:mt-1 mb-1.5 px-2">
                  <span>{title}</span><span className="h-px flex-1 bg-line" />
                </div>
                {items.map(([k, l, Icon], ii) => {
                  const active = view === k;
                  return (
                    <button key={k} onClick={() => setView(k)}
                      style={{ animation: "sideIn .5s cubic-bezier(.22,1,.36,1) backwards", animationDelay: `${(gi * 4 + ii) * 50}ms` }}
                      className={`group relative flex items-center gap-3 pl-3 pr-2.5 py-2 rounded-xl text-[13.5px] font-semibold whitespace-nowrap transition-all duration-200 shrink-0 active:scale-[0.97] ${active ? "bg-brand/[0.12] text-brand shadow-[inset_0_0_0_1px_rgba(24,168,132,.28)]" : "text-ink2 hover:text-ink hover:bg-white/[0.03] lg:hover:translate-x-1"}`}>
                      {/* glowing left accent bar */}
                      <span className={`hidden lg:block absolute left-0 top-1/2 -translate-y-1/2 w-[3px] rounded-full bg-brand transition-all duration-300 ${active ? "h-6 opacity-100 shadow-[0_0_8px_rgba(24,168,132,.7)]" : "h-0 opacity-0 group-hover:h-4 group-hover:opacity-50"}`} />
                      {/* icon tile */}
                      <span className={`grid place-items-center w-8 h-8 rounded-lg transition-all duration-200 group-active:scale-90 ${active ? "bg-brand text-white shadow-[0_5px_14px_-4px_rgba(24,168,132,.7)] animate-[pop_.35s_ease]" : "bg-white/[0.05] text-ink2 group-hover:bg-brand/15 group-hover:text-brand group-hover:scale-105 group-hover:-rotate-3"}`}>
                        <Icon size={16} />
                      </span>
                      <span className="flex-1 text-left">{l}</span>
                      {k === "interview" && <span className="text-[9px] font-bold bg-brand text-white px-1.5 py-0.5 rounded-full">PRO</span>}
                      {/* hover / active chevron */}
                      <ChevronRight size={15} className={`hidden lg:block shrink-0 transition-all duration-200 ${active ? "opacity-100 text-brand" : "opacity-0 -translate-x-1 text-ink2 group-hover:opacity-70 group-hover:translate-x-0"}`} />
                    </button>
                  );
                })}
              </div>
        ...
        <div key={view} className="min-w-0" style={{ animation: "secUp .28s ease both" }}>
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 min-[1800px]:grid-cols-5 gap-4">
            {filteredTopics.map((t, idx) => {
              ...
              const pct = t.problems.length ? Math.round((tSolved / t.problems.length) * 100) : 0;
              return (
                <div key={t.name} className="rounded-2xl border border-line bg-card p-5 flex flex-col hover:border-brand/30 transition-colors">
                  <div className="flex items-start gap-3 mb-3">
                    <span className="grid place-items-center w-9 h-9 rounded-xl text-white font-bold text-sm shrink-0" style={{ background: "linear-gradient(135deg,#18a884,#0f8163)" }}>{idx + 1}</span>
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center justify-between gap-2">
                        <h3 className="font-display text-base font-semibold leading-tight truncate">{t.name}</h3>
                        <span className="text-[11px] font-semibold text-ink2 shrink-0">{tSolved}/{t.problems.length}</span>
                      </div>
                      <p className="text-xs text-ink2 leading-snug mt-0.5 truncate">{t.patterns}</p>
                    </div>
                  </div>
                  <div className="h-1 rounded-full bg-line overflow-hidden mb-3">
                    <div className="h-full rounded-full transition-all duration-500" style={{ width: `${pct}%`, background: "linear-gradient(90deg,#18a884,#2dd4bf)" }} />
                  </div>
                  <div className="flex flex-col gap-0.5">
                    {t.problems.map(([p, d]) => {
                      ...
                      return (
                        <div key={p} className="group flex items-center gap-2.5 pl-2 pr-2.5 py-2 rounded-lg hover:bg-paper transition">
                          <button onClick={() => toggleSolved(p)} title={isSolved ? "Solved — click to undo" : "Mark as solved"}
                            className="shrink-0 grid place-items-center w-5 h-5 rounded-full border transition"
                            style={{ borderColor: isSolved ? "#18a884" : "var(--color-line)", background: isSolved ? "#18a884" : "transparent" }}>
                            {isSolved && <Check size={12} className="text-white" />}
                          </button>
                          {solvable ? (
                            <button onClick={() => ivNav(`/problem/${encodeURIComponent(p)}`)} className="flex items-center gap-2 flex-1 min-w-0 text-left">
                              <span className={`text-sm truncate ${isSolved ? "line-through text-ink2" : "text-ink"}`}>{p}</span>
                              <span className="ml-auto shrink-0 text-[9px] font-bold px-1.5 py-0.5 rounded-md bg-brand text-white tracking-wide">SOLVE</span>
                              <span className="shrink-0 text-[10px] font-bold px-1.5 py-0.5 rounded-md" style={{ color: diffColor(d), background: diffColor(d) + "1a" }}>{d}</span>
                            </button>
                          ) : (
                            <a href={lc(p)} target="_blank" rel="noreferrer" className="flex items-center gap-2 flex-1 min-w-0">
                              <span className={`text-sm truncate ${isSolved ? "line-through text-ink2" : "text-ink"}`}>{p}</span>
                              <span className="ml-auto shrink-0 text-[10px] font-bold px-1.5 py-0.5 rounded-md" style={{ color: diffColor(d), background: diffColor(d) + "1a" }}>{d}</span>
                              <ExternalLink size={13} className="shrink-0 text-ink2 group-hover:text-brand transition" />
                            </a>
                          )}
                        </div>
                      );
          ...
          {!asChosen ? (
            <div>
              <div className="flex items-center gap-3 mb-5">
                <div className="grid place-items-center w-11 h-11 rounded-xl bg-brand/10"><Timer className="text-brand" size={22} /></div>
                <div><h3 className="font-display text-xl font-semibold">Assessments</h3><p className="text-sm text-ink2">Pick a timed assessment — you get fresh random questions each attempt.</p></div>
              </div>
              <div className="grid sm:grid-cols-2 gap-3">
                {ASSESSMENTS.map((a) => {
                  const col = a.type === "system" ? "#d4a23a" : a.type === "mixed" ? "#7c3aed" : "#18a884";
                  const tag = a.type === "system" ? "System Design" : a.type === "mixed" ? "Mixed" : "DSA";
                  return (
                    <div key={a.id} className="rounded-2xl border border-line bg-card p-5 flex flex-col">
                      <span className="self-start text-[10px] font-bold px-2 py-0.5 rounded-full mb-2" style={{ color: col, background: col + "1a" }}>{tag}</span>
                      <h4 className="font-display text-lg font-semibold">{a.name}</h4>
                      <p className="text-sm text-ink2 mt-1 mb-3 flex-1">{a.desc}</p>
                      <div className="flex items-center gap-3 text-xs text-ink2 mb-3">
                        <span className="inline-flex items-center gap-1"><Layers size={13} /> {a.count} questions</span>
                        <span className="inline-flex items-center gap-1"><Timer size={13} /> {a.mins} min</span>
                      </div>
                      <button onClick={() => asStart(a)} className="w-full inline-flex items-center justify-center gap-2 py-2.5 rounded-xl bg-brand text-white font-semibold hover:bg-brand-dark transition">Start <ChevronRight size={16} /></button>
                    </div>
                  );
                })}
              </div>
            ...
            <div className="rounded-2xl border border-line bg-card p-6 sm:p-8 text-center">
              <div className="mx-auto w-14 h-14 grid place-items-center rounded-2xl bg-brand/10 mb-4"><Trophy className="text-brand" size={26} /></div>
              <h3 className="font-display text-2xl font-semibold mb-1">{asChosen.name} complete</h3>
              <p className="text-ink2 mb-5">Marked {Object.values(asSolved).filter(Boolean).length} of {asItems.length} done · time used {fmt(Math.max(0, asChosen.mins * 60 - asLeft))}</p>
              <div className="flex flex-col gap-2 max-w-md mx-auto mb-6 text-left">
                {asItems.map((it, i) => (
                  <div key={i} className="flex items-center justify-between gap-2 rounded-lg border border-line bg-paper/40 px-4 py-2.5">
                    <span className="text-sm font-medium truncate">{it.type === "dsa" ? it.name : it.q.title}</span>
                    <span className={`shrink-0 text-xs font-bold px-2 py-0.5 rounded-full ${asSolved[i] ? "text-brand bg-brand/10" : "text-ink2 bg-card"}`}>{asSolved[i] ? "Done" : "Skipped"}</span>
                  </div>
                ))}
              </div>
              <button onClick={asReset} className="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-brand text-white font-semibold hover:bg-brand-dark transition"><RotateCcw size={17} /> Back to assessments</button>
            </div>
          ) : (() => {
            ...
            return (
              <div className="rounded-2xl border border-line bg-card p-4 sm:p-5">
                <div className="flex items-center justify-between gap-2 mb-3 flex-wrap">
                  <span className="text-sm font-semibold text-ink2">{asChosen.name}</span>
                  <button onClick={asReset} className="inline-flex items-center gap-1 text-xs font-semibold text-ink2 hover:text-rust transition"><RotateCcw size={13} /> Exit</button>
                </div>
                <div className="flex items-center justify-between gap-3 mb-4 flex-wrap">
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-xl font-bold text-lg" style={{ fontFamily: "ui-monospace, Menlo, monospace", background: low ? "rgba(224,116,58,.12)" : "rgba(255,255,255,.05)", color: low ? "#e0743a" : "var(--color-ink)" }}>
                    <Timer size={18} /> {fmt(asLeft)}
                  </div>
                  <div className="flex items-center gap-1.5">
                    {asItems.map((it, i) => (
                      <button key={i} onClick={() => setAsActive(i)} className={`w-8 h-8 rounded-lg text-sm font-bold transition ${i === asActive ? "bg-brand text-white" : asSolved[i] ? "bg-brand/15 text-brand" : "bg-paper/40 text-ink2 border border-line"}`}>{i + 1}</button>
                    ))}
                  </div>
                  <button onClick={asFinish} className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg border border-line bg-paper/40 text-sm font-semibold text-ink2 hover:text-rust transition">Finish</button>
                </div>
                ...
                {item.type === "dsa" ? (() => {
                  ...
                  return (
                    <>
                      ...
                      <p className="text-sm leading-6 text-ink mb-3">{pr.statement}</p>
                      <div className="flex flex-col gap-2 mb-3">
                        {pr.examples.slice(0, 2).map((ex, i) => (
                          <div key={i} className="rounded-lg border border-line bg-paper/40 px-3 py-2 text-[13px]" style={{ fontFamily: "ui-monospace, Menlo, monospace" }}>
                            <div><span className="text-ink2">In: </span>{ex.input}</div>
                            <div><span className="text-ink2">Out: </span>{ex.output}</div>
                          </div>
                        ))}
                      </div>
                      <Lazy><CodeRunner key={"dsa" + asActive} initialLangKey="python" initialCode={pr.starter} tests={pr.tests} funcName={pr.func} /></Lazy>
                    </>
                  );
                })() : (
                  <>
                    <h3 className="font-display text-lg font-semibold mb-1">{item.q.title}</h3>
                    <p className="text-sm leading-6 text-ink mb-3">{item.q.prompt}</p>
                    {item.q.points && item.q.points.length > 0 && (
                      <div className="rounded-xl border border-line bg-paper/40 px-4 py-3 mb-3">
                        <div className="text-[11px] font-bold uppercase tracking-wide text-ink2 mb-1.5">Make sure you cover</div>
                        <ul className="flex flex-col gap-1.5">{item.q.points.map((pt, i) => (<li key={i} className="flex gap-2 text-sm text-ink2"><span className="text-brand">•</span><span>{pt}</span></li>))}</ul>
                      </div>
                    )}
                    <textarea rows={8} value={asNotes[asActive] || ""} onChange={(e) => setAsNotes((m) => ({ ...m, [asActive]: e.target.value }))}
                ...
                <div className="flex justify-end mt-3">
                  <button onClick={() => setAsSolved((m) => ({ ...m, [asActive]: !m[asActive] }))}
                    ...
                    <Check size={15} /> {asSolved[asActive] ? "Marked done" : "Mark done"}
                  </button>
                </div>
              </div>
            );
      ...
      {view === "system" && (
        <div className="w-full">
          ...
          <h2 className="font-display text-xl font-semibold mb-1">Practice ({sysDesign.length} questions)</h2>
          <p className="text-ink2 text-sm mb-4">Pick a question, tick off the points as you cover them, and sketch your design.</p>
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4 mb-9">
            {sysDesign.map((qq, i) => (
              <button key={qq.title} onClick={() => setActiveSys(qq)} className="text-left rounded-2xl border border-line bg-card p-5 hover:border-brand transition flex flex-col">
                <div className="flex items-center gap-2 mb-1">
                  <span className="grid place-items-center w-7 h-7 rounded-lg bg-brand/10 text-brand font-bold text-sm shrink-0">{i + 1}</span>
                  <h3 className="font-semibold leading-tight">{qq.title}</h3>
                </div>
                <p className="text-xs text-ink2 leading-snug pl-9">{(qq.points || []).length} key points to cover</p>
              </button>
            ))}
          </div>

          <h2 className="font-display text-xl font-semibold mb-1">More to try</h2>
      ...
      {view === "code" && (
        <div className="w-full">
          ...
          <div className="mb-9"><Lazy><CodeRunner /></Lazy></div>

          <h2 className="font-display text-xl font-semibold mb-1">System design workspace</h2>
          <p className="text-ink2 text-sm mb-4">Pick a prompt and design it right here — tick the points as you cover them and write your approach.</p>
          <div className="rounded-2xl border border-line bg-card p-5 mb-9">
            <select value={codeSysIdx} onChange={(e) => setCodeSysIdx(Number(e.target.value))}
              ...
              {sysDesign.map((qq, i) => <option key={qq.title} value={i}>{qq.title}</option>)}
            </select>
            {(() => {
              ...
              return (
                <>
                  <p className="text-[15px] leading-7 text-ink mb-4">{qq.prompt}</p>
                  {pts.length > 0 && (
                    <>
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-sm font-semibold">Cover these points</span>
                        <span className="text-xs font-semibold text-ink2">{done} / {pts.length}</span>
                      </div>
                      <div className="h-2 rounded-full bg-line overflow-hidden mb-4">
                        <div className="h-full rounded-full" style={{ width: `${(done / pts.length) * 100}%`, background: "linear-gradient(90deg,#18a884,#2dd4bf)", transition: "width .4s ease" }} />
                      </div>
                      <ul className="flex flex-col gap-2 mb-5">
                        {pts.map((pt, i) => (
                          <li key={i}>
                            <button onClick={() => setCodeSysChecks((m) => ({ ...m, [i]: !m[i] }))} className="w-full flex items-start gap-2.5 text-left text-sm">
                              <span className="shrink-0 mt-0.5 grid place-items-center w-5 h-5 rounded-md border transition" style={{ borderColor: codeSysChecks[i] ? "#18a884" : "var(--color-line)", background: codeSysChecks[i] ? "#18a884" : "transparent" }}>{codeSysChecks[i] && <Check size={12} className="text-white" />}</span>
                              <span className={codeSysChecks[i] ? "text-ink2 line-through" : "text-ink"}>{pt}</span>
                            </button>
                          </li>
                        ))}
                      </ul>
                  ...
                  <textarea rows={8} value={codeSysNotes} onChange={(e) => setCodeSysNotes(e.target.value)} placeholder="Design here: core components, data model, APIs, scaling, bottlenecks & trade-offs…" className="w-full rounded-xl border border-line bg-paper/50 px-4 py-3 text-sm text-ink outline-none focus:border-brand transition resize-y" />
                </>
              );
            })()}
          </div>
      ...
      {view === "sql" && (
        <div className="w-full">
          <div className="flex items-center gap-3 mb-5">
            <div className="grid place-items-center w-11 h-11 rounded-xl bg-brand/10"><Database className="text-brand" size={22} /></div>
            <div><h3 className="font-display text-xl font-semibold">SQL Practice</h3><p className="text-sm text-ink2">Write real queries against a live in-browser database, judged like LeetCode. {sqlProblems.length} problems.</p></div>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {sqlProblems.map((pb) => (
              <button key={pb.id} onClick={() => setActiveSql(pb)} className="text-left rounded-2xl border border-line bg-card p-5 hover:border-brand transition flex flex-col">
                <div className="flex items-center justify-between gap-2 mb-1">
                  <h4 className="font-display text-base font-semibold">{pb.title}</h4>
                  <span className="shrink-0 text-[10px] font-bold px-2 py-0.5 rounded-full" style={{ color: diffColor(pb.difficulty), background: diffColor(pb.difficulty) + "1a" }}>{pb.difficulty}</span>
                </div>
      ...
      {activeSys && (
        <div className="fixed inset-0 z-50 flex items-stretch sm:items-center justify-center p-0 sm:p-6" style={{ background: "rgba(0,0,0,.65)" }} onClick={() => setActiveSys(null)}>
          <div onClick={(e) => e.stopPropagation()} className="relative bg-card border border-line w-full sm:max-w-2xl sm:rounded-2xl overflow-hidden flex flex-col max-h-screen sm:max-h-[92vh]" style={{ animation: "secUp .25s ease both" }}>
            <div className="flex items-center justify-between gap-3 p-5 border-b border-line shrink-0">
              <h2 className="font-display text-xl font-semibold truncate">{activeSys.title}</h2>
              <button onClick={() => setActiveSys(null)} aria-label="Close" className="grid place-items-center w-9 h-9 rounded-lg border border-line bg-white text-ink2 hover:text-ink shrink-0"><X size={18} /></button>
            </div>
            <div className="overflow-y-auto p-5 sm:p-6">
              <p className="text-[15px] leading-7 text-ink mb-5">{activeSys.prompt}</p>
              {(activeSys.points || []).length > 0 && (() => {
                const done = activeSys.points.filter((_, i) => sysChecks[i]).length;
                return (
                  <>
                    <div className="flex items-center justify-between mb-2">
                      <h4 className="font-display text-base font-semibold">Cover these points</h4>
                      <span className="text-xs font-semibold text-ink2">{done} / {activeSys.points.length}</span>
                    </div>
                    <div className="h-2 rounded-full bg-line overflow-hidden mb-4">
                      <div className="h-full rounded-full" style={{ width: `${(done / activeSys.points.length) * 100}%`, background: "linear-gradient(90deg,#18a884,#2dd4bf)", transition: "width .4s ease" }} />
                    </div>
                    <ul className="flex flex-col gap-2 mb-6">
                      {activeSys.points.map((pt, i) => (
                        <li key={i}>
                          <button onClick={() => setSysChecks((m) => ({ ...m, [i]: !m[i] }))} className="w-full flex items-start gap-2.5 text-left text-sm">
                            <span className="shrink-0 mt-0.5 grid place-items-center w-5 h-5 rounded-md border transition" style={{ borderColor: sysChecks[i] ? "#18a884" : "var(--color-line)", background: sysChecks[i] ? "#18a884" : "transparent" }}>{sysChecks[i] && <Check size={12} className="text-white" />}</span>
                            <span className={sysChecks[i] ? "text-ink2 line-through" : "text-ink"}>{pt}</span>
                          </button>
                        </li>
                      ))}
                    </ul>
              ...
              <h4 className="font-display text-base font-semibold mb-2">Your design</h4>
              <textarea rows={8} value={sysNotes} onChange={(e) => setSysNotes(e.target.value)} placeholder="Sketch your design: core components, data model, APIs, scaling, bottlenecks & trade-offs…" className="w-full rounded-xl border border-line bg-paper/50 px-4 py-3 text-sm text-ink outline-none focus:border-brand transition resize-y" />
            </div>
          </div>
        </div>
      )}
      ...
      {activeSql && (
        <div className="fixed inset-0 z-50 flex items-stretch sm:items-center justify-center p-0 sm:p-6" style={{ background: "rgba(0,0,0,.65)" }} onClick={() => setActiveSql(null)}>
          <div onClick={(e) => e.stopPropagation()} className="relative bg-card border border-line w-full sm:max-w-3xl sm:rounded-2xl overflow-hidden flex flex-col max-h-screen sm:max-h-[92vh]" style={{ animation: "secUp .25s ease both" }}>
            <div className="flex items-center justify-between gap-3 p-5 border-b border-line shrink-0">
              <div className="min-w-0">
                <h2 className="font-display text-xl font-semibold truncate">{activeSql.title}</h2>
                <p className="text-xs text-ink2 truncate">{activeSql.topic}</p>
              </div>
              <div className="flex items-center gap-2 shrink-0">
                <span className="text-[11px] font-bold px-2 py-0.5 rounded-full" style={{ color: diffColor(activeSql.difficulty), background: diffColor(activeSql.difficulty) + "1a" }}>{activeSql.difficulty}</span>
                <button onClick={() => setActiveSql(null)} aria-label="Close" className="grid place-items-center w-9 h-9 rounded-lg border border-line bg-white text-ink2 hover:text-ink"><X size={18} /></button>
              </div>
            </div>
            <div className="overflow-y-auto p-5 sm:p-6">
              <p className="text-[15px] leading-7 text-ink mb-4">{activeSql.prompt}</p>
              <details className="mb-5 rounded-xl border border-line bg-paper px-4 py-3">
                <summary className="cursor-pointer text-sm font-semibold text-brand select-none">View tables &amp; sample data</summary>
                <pre className="mt-3 text-[12px] text-ink2 whitespace-pre-wrap leading-relaxed" style={{ fontFamily: "ui-monospace, Menlo, monospace" }}>{activeSql.schema}</pre>
              </details>
              <Lazy><SqlRunner schema={activeSql.schema} expected={activeSql.expected} ordered={!!activeSql.ordered} /></Lazy>
            </div>
          </div>
        </div>
      )}
              ...
              <div className="overflow-y-auto p-5 sm:p-6">
                ...
                <div className="rounded-xl border border-line bg-paper px-4 py-3 mb-6">
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    <button onClick={getHint} disabled={pHintLoading}
                      ...
                      {pHintLoading ? <Loader2 size={14} className="animate-spin" /> : <Lightbulb size={14} />} Get a hint
                    </button>
                    <button onClick={getSolution} disabled={pSolLoading}
                      ...
                      {pSolLoading ? <Loader2 size={14} className="animate-spin" /> : <Crown size={14} />} Show solution
                    </button>
                  </div>
                  {pHelpErr && <p className="text-sm text-rust mt-2">{pHelpErr}</p>}
                  {pHint && (
                    <div className="mt-3 text-sm leading-6 rounded-lg bg-brand/5 border border-brand/20 px-3 py-2.5" style={{ color: "#cdd3de" }}>
                      <span className="font-semibold text-brand">Hint: </span>{pHint}
                    </div>
                  )}
                  {pSol && (
                    <div className="mt-3 rounded-lg border border-line bg-card overflow-hidden">
                      <div className="flex items-center justify-between px-3 py-2 border-b border-line">
                        <span className="text-xs font-bold uppercase tracking-wide text-ink2">Editorial</span>
                        <button onClick={() => navigator.clipboard.writeText(pSol)} className="text-xs font-semibold text-brand hover:underline">Copy</button>
                      </div>
                      <pre className="px-3 py-3 text-[13px] text-ink whitespace-pre-wrap leading-relaxed" style={{ fontFamily: "inherit" }}>{pSol}</pre>
                    </div>
                  )}
                </div>
                ...
                <Lazy><CodeRunner key={activeProblem} initialLangKey="python" initialCode={pr.starter} tests={pr.tests} funcName={pr.func} onResult={(v) => recordSubmission(activeProblem, v)} /></Lazy>
              </div>
            </div>
          </div>
        );
