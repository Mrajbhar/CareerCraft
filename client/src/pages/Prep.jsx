  ...
  return (
    <div className="w-full px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
      ...
      <div className="flex justify-center gap-2 mb-7 flex-wrap">
        {[["dsa", "DSA Topics", Brain], ["theory", "DSA Course", GraduationCap], ["interview", "Mock Interview", Mic], ["assessment", "Assessments", Timer], ["behavioral", "Behavioral", MessageSquare], ["system", "System Design", Network], ["code", "Code Practice", Code2], ["sql", "SQL", Database], ["companies", "Companies", Building2]].map(([k, l, Icon]) => (
                ...
                {item.type === "dsa" ? (() => {
                  ...
                  return (
                    <>
                      ...
                      <CodeRunner key={"dsa" + asActive} initialLangKey="python" initialCode={pr.starter} tests={pr.tests} funcName={pr.func} />
                    </>
                  );
                })() : (
                  <>
        ...
        <div className="fixed inset-0 z-50 flex items-stretch sm:items-center justify-center p-0 sm:p-6" style={{ background: "rgba(0,0,0,.65)" }} onClick={() => setActiveSql(null)}>
          <div onClick={(e) => e.stopPropagation()} className="relative bg-card border border-line w-full sm:max-w-3xl sm:rounded-2xl overflow-hidden flex flex-col max-h-screen sm:max-h-[92vh]" style={{ animation: "secUp .25s ease both" }}>
            ...
            <div className="overflow-y-auto p-5 sm:p-6">
              ...
              <SqlRunner schema={activeSql.schema} expected={activeSql.expected} ordered={!!activeSql.ordered} />
            </div>
          </div>
        </div>
      )}
          ...
          <div className="fixed inset-0 z-50 flex items-stretch sm:items-center justify-center p-0 sm:p-6" style={{ background: "rgba(0,0,0,.65)" }} onClick={() => setActiveProblem(null)}>
            <div onClick={(e) => e.stopPropagation()} className="relative bg-card border border-line w-full sm:max-w-4xl sm:rounded-2xl overflow-hidden flex flex-col max-h-screen sm:max-h-[92vh]" style={{ animation: "secUp .25s ease both" }}>
              ...
              <div className="overflow-y-auto p-5 sm:p-6">
                ...
                <CodeRunner key={activeProblem} initialLangKey="python" initialCode={pr.starter} tests={pr.tests} funcName={pr.func} />
              </div>
            </div>
          </div>
        );
